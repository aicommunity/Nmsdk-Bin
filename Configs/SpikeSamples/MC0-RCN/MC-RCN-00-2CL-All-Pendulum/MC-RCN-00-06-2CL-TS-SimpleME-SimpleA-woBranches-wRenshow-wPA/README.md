## MC-RCN-00-06-2CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA — двухуровневый рефлекторный контур с TS-SimpleME и маятником

**Путь:** `Bin/Configs/SpikeSamples/MC0-RCN/MC-RCN-00-2CL-All-Pendulum/MC-RCN-00-06-2CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA`  
...
- Двигательный элемент типа TS (TS-SimpleME), Простая афферентация (SimpleA), Без ветвления (woBranches), С клетками Реншоу (wRenshow), С пресинаптическим торможением (wPA)
...
Согласно [A] и `MuscleControlStructures.md`, двухуровневые контуры обеспечивают более точное управление за счёт использования нескольких сенсорных сигналов. Данная конфигурация аналогична `MC-RCN-00-06-2CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA` из группы `MC-RCN-00-2CL-All-DcEngine`, но использует модель маятника вместо DC-двигателя.

### Отличия от других конфигураций

Данная конфигурация отличается:
- От `MC-RCN-00-06-1CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA` из группы `MC-RCN-00-1CL-All-Pendulum`: использованием двух контуров управления (2CL вместо 1CL)
- От `MC-RCN-00-06-2CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA` из группы `MC-RCN-00-2CL-All-DcEngine`: использованием модели маятника вместо DC-двигателя
...
- Аналогичные конфигурации:
  - [`../MC-RCN-00-1CL-All-Pendulum/MC-RCN-00-06-1CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA/README.md`](../../MC-RCN-00-1CL-All-Pendulum/MC-RCN-00-06-1CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA/README.md) — одноуровневая конфигурация с маятником
  - [`../MC-RCN-00-2CL-All-DcEngine/MC-RCN-00-06-2CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA/README.md`](../../MC-RCN-00-2CL-All-DcEngine/MC-RCN-00-06-2CL-TS-SimpleME-SimpleA-woBranches-wRenshow-wPA/README.md) — двухуровневая конфигурация с DC-двигателем
