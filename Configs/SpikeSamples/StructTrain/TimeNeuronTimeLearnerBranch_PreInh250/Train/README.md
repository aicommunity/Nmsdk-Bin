...
Test: [`TimeNeuronTimeLearnerBranchTest_PreInh250`](../Test) → **7/8** (fn=0, fp=1, late_fp=3) после полного sync.\
Порог: [`../TimeNeuronTimeLearnerBranch/REPORT_preinh250_threshold.md`](../../TimeNeuronTimeLearnerBranch/Train/REPORT_preinh250_threshold.md).
