...
Вывод: PASS на разных длительностях/моделях — это **робастный перенос рецепта и last-pulse**, не широкий порог. Амплитудный запас @50 ≈ @25; @100 — лезвие. Причины: схождение foil/target ltz на длинной интеграции; TipR@Rmin чинит знак gap, но не его ширину; clone моделей не меняет физику gap.
