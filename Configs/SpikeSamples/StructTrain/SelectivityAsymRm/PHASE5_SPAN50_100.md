...
Итог: проги **робастны как процедура/рецепт** (перенос на span и twin/pack), но **не робастны как FixedLTZ-маржа**; @100 хуже @25/50.

Полный разбор хрупкости порога, сравнение с эталоном ~480 мс, Probe A/B и ограничения на смену модели нейрона: [`THR_FRAGILITY_DIAG.md`](THR_FRAGILITY_DIAG.md).
