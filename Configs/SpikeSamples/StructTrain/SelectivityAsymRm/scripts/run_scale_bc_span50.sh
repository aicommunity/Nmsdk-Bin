#!/usr/bin/env bash
# Wave 2: Pack B/C span50 only (MAX_JOBS default 6).
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
export PILOT_EXPS="${SCALE_PILOT_EXPS:-EXP_span50ms_packB_gen EXP_span50ms_packB_preinh EXP_span50ms_packC_gen EXP_span50ms_packC_preinh}"
unset AMP_ONLY || true
...
export LENGTH_STEPS_SPAN50="${LENGTH_STEPS_SPAN50:-80 160 320 640 1280 2560}"
