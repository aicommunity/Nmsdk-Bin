...
ANALYZER_LINKS = """			<elem Type="ULink">
				<Item Type="ULinkSide" Index="-1" Name="Output">NeuronTimeLearnerBranch.DatasetMatrix.Generator1</Item>
				<Connector Type="ULinkSide" Index="-1" Name="StimulusInputs">PatternResponseAnalyzer</Connector>
			</elem>
			<elem Type="ULink">
				<Item Type="ULinkSide" Index="-1" Name="Output">NeuronTimeLearnerBranch.Neuron.LTZone</Item>
				<Connector Type="ULinkSide" Index="-1" Name="NeuronOutputs">PatternResponseAnalyzer</Connector>
			</elem>
			<elem Type="ULink">
				<Item Type="ULinkSide" Index="-1" Name="CurrentClassMatrix">NeuronTimeLearnerBranch.DatasetMatrix</Item>
...
ANALYZER_COMPONENT = """			<PatternResponseAnalyzer Class="NPatternResponseAnalyzer">
				<Parameters>
					...
					<LearnerComponentName Type="std::string" PType="257" IoType="17">NeuronTimeLearnerBranch</LearnerComponentName>
					...
					<MatchMode Type="i" PType="257" IoType="17">0</MatchMode>
				</Parameters>
				<Components/>
