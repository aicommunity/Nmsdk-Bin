## EXP04_preinh_250 — Test (селективность, 8 trials)

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP04_preinh_250/Test`  
...
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP04_preinh_250/Test/Project.ini -s -t 20 -x
```
