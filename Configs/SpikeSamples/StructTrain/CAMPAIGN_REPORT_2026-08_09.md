...
| Stuck Pack C gen 50 / 100 (**историческое**; закрыто PHASE5 clone→C1e9) | [`EXP_span50ms_packC_gen`](SelectivityAsymRm/EXP_span50ms_packC_gen), [`EXP_span100ms_packC_gen`](SelectivityAsymRm/EXP_span100ms_packC_gen) — live **8/8** |
...
6. **Pack C gen** (50/100) закрыты PHASE5 (clone→C1e9 + TipR@Rmin). PHASE6 @480 best **7/8**. PHASE7 Branch tiprmin **8/8**. PHASE8 Branch short-span packA **6/6 PASS** (span100 gen: Done TipR fallback). **PHASE9** (2026-09-14): GATE incl. PHASE8; pack B/C / AsymRm preinh B/C C1e9 / NextSeg short / quality — см. [`PHASE9_COVERAGE.md`](PHASE9_COVERAGE.md). **PHASE10** (2026-09-14…15): S0 disk pack; T0–T2; PSI/FastSpan C1e9; FR tiprmin probe — [`PHASE10_COVERAGE.md`](PHASE10_COVERAGE.md). Карта: [`RECIPE_COVERAGE.md`](RECIPE_COVERAGE.md).  
7. Полный аудит: [`AUDIT_REPORT.md`](AUDIT_REPORT.md), layout: [`LAYOUT.md`](LAYOUT.md), GATE: [`AUDIT_GATE_RECOMPUTE.csv`](AUDIT_GATE_RECOMPUTE.csv) (**167 / 77** на 2026-09-15).
