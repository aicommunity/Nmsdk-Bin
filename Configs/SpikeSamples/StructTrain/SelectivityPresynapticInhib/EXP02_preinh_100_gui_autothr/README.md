## EXP02_preinh_100_gui_autothr — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP02_preinh_100_gui_autothr`  
...
GUI-веса EXP02 + повторная калибровка autothr без cold reset.
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP02_preinh_100_gui_autothr/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP02_preinh_100_gui_autothr/Test/Project.ini -s -t 20 -x
```
