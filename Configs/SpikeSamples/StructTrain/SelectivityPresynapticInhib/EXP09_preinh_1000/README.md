## EXP09_preinh_1000 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP09_preinh_1000`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh10_0`
- **k (PSI):** `10.0`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP09_preinh_1000/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP09_preinh_1000/Test/Project.ini -s -t 20 -x
```
