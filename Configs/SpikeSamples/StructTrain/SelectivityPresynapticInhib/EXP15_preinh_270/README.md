## EXP15_preinh_270 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP15_preinh_270`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh2_7`
- **k (PSI):** `2.7`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP15_preinh_270/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP15_preinh_270/Test/Project.ini -s -t 20 -x
```
