## EXP01_preinh_050_autothr — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP01_preinh_050_autothr`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh0_5`
- **k (PSI):** `0.5`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP01_preinh_050_autothr/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP01_preinh_050_autothr/Test/Project.ini -s -t 20 -x
```
