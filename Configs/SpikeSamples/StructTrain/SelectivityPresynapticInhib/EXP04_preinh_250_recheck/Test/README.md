## EXP04_preinh_250_recheck — Test (селективность, 8 trials)

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP04_preinh_250_recheck/Test`  
