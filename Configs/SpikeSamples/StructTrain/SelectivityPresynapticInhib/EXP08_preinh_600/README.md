## EXP08_preinh_600 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP08_preinh_600`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh6_0`
- **k (PSI):** `6.0`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP08_preinh_600/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP08_preinh_600/Test/Project.ini -s -t 20 -x
```
