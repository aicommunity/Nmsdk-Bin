## EXP02_preinh_100_autothr — Train (обучение структуры + autothr)

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP02_preinh_100_autothr/Train`  
