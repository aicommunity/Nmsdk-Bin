## EXP14_preinh_260 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP14_preinh_260`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh2_6`
- **k (PSI):** `2.6`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP14_preinh_260/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP14_preinh_260/Test/Project.ini -s -t 20 -x
```
