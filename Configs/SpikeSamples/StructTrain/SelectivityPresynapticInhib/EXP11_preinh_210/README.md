## EXP11_preinh_210 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP11_preinh_210`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh2_1`
- **k (PSI):** `2.1`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP11_preinh_210/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP11_preinh_210/Test/Project.ini -s -t 20 -x
```
