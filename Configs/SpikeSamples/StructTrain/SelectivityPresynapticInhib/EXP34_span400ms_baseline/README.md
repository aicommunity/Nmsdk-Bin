## EXP34_span400ms_baseline — PSI time-expand

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP34_span400ms_baseline`  
...
NeuroModelerConsole -c /home/user/Nmsdk/Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP34_span400ms_baseline/Test/Project.ini -s -t 20 -x
```
