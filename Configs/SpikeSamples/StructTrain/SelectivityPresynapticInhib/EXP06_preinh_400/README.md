## EXP06_preinh_400 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP06_preinh_400`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh4_0`
- **k (PSI):** `4.0`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP06_preinh_400/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP06_preinh_400/Test/Project.ini -s -t 20 -x
```
