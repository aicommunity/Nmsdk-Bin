## EXP12_preinh_220 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP12_preinh_220`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh2_2`
- **k (PSI):** `2.2`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP12_preinh_220/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP12_preinh_220/Test/Project.ini -s -t 20 -x
```
