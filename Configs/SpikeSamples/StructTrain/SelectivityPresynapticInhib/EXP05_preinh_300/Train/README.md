## EXP05_preinh_300 — Train (обучение структуры + autothr)

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP05_preinh_300/Train`  
...
```bash
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP05_preinh_300/Train/Project.ini -s -t 90 -x -S
