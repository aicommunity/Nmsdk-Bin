## EXP13_preinh_240 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP13_preinh_240`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh2_4`
- **k (PSI):** `2.4`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP13_preinh_240/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP13_preinh_240/Test/Project.ini -s -t 20 -x
```
