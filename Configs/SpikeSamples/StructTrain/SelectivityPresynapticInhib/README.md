...
Отчёты: [REPORT.md](REPORT.md), [REPORT_autothr.md](REPORT_autothr.md), [REPORT_gui_autothr.md](REPORT_gui_autothr.md), [REPORT_k_sweep.md](REPORT_k_sweep.md).
...
./scripts/setup_k_sweep.sh   # новые EXP; не трогает EXP00–03
