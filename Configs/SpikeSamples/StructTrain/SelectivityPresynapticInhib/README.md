...
Отчёты: [REPORT.md](REPORT.md), [REPORT_autothr.md](REPORT_autothr.md), [REPORT_gui_autothr.md](REPORT_gui_autothr.md), [REPORT_k_sweep.md](REPORT_k_sweep.md), [REPORT_time_compress.md](REPORT_time_compress.md) (Erratum + Run3 full-tune), [REPORT_time_expand.md](REPORT_time_expand.md) (span 200/300/400 мс, EXP30–35, Run3).
