## EXP07_preinh_500 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP07_preinh_500`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh5_0`
- **k (PSI):** `5.0`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP07_preinh_500/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP07_preinh_500/Test/Project.ini -s -t 20 -x
```
