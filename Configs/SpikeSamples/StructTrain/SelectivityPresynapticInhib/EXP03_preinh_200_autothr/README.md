## EXP03_preinh_200_autothr — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP03_preinh_200_autothr`  
...
Вариант с включённым `AutoCalibrateFixedLTZThreshold` (исторический batch / follow-up).

### Параметры нейрона

- **NeuronClassName:** `NSPNeuronGenPreinh2_0`
- **k (PSI):** `2.0`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP03_preinh_200_autothr/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP03_preinh_200_autothr/Test/Project.ini -s -t 20 -x
```
