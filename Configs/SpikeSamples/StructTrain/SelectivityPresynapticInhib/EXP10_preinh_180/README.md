## EXP10_preinh_180 — PSI k-sweep / selectivity

**Путь:** `Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP10_preinh_180`  
...
- **NeuronClassName:** `NSPNeuronGenPreinh1_8`
- **k (PSI):** `1.8`
...
```bash
# Train
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP10_preinh_180/Train/Project.ini -s -t 90 -x -S
# sync + Test — см. scripts/copy_config.sh
NeuroModelerConsole -c Bin/Configs/SpikeSamples/StructTrain/SelectivityPresynapticInhib/EXP10_preinh_180/Test/Project.ini -s -t 20 -x
```
