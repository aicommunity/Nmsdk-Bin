...
Отвержение distractors ещё слабое: часть чужих ISI и локальные сгущения в начале окна всё ещё вызывают спайк. Поздняя концентрация нагрузки и равномерная сетка отвергаются лучше.
